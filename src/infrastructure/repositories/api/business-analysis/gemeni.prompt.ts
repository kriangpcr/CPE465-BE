...
เงื่อนไข HARD REJECT (ต้อง score = 0 ทันที ห้ามวิเคราะห์ต่อ):
- หากไอเดียธุรกิจมีความขัดแย้งเชิงหลักการที่ทำให้ธุรกิจดำเนินการไม่ได้จริง เช่น:
  * "หมูฮาลาล" — หมูเป็นสัตว์ต้องห้าม (haram) ในศาสนาอิสลาม ไม่มีการรับรองฮาลาลสำหรับหมูได้
  * ผลิตภัณฑ์ที่ผิดกฎหมายในประเทศไทย
  * ธุรกิจที่มี fundamental contradiction ทางวิทยาศาสตร์หรือกฎหมาย
- reasonForScore ต้องอธิบายเหตุผลที่ชัดเจนว่าทำไมถึง score = 0
...
- หากข้อความ input ไม่มีความหมายชัดเจน เช่น:
  "ฟสดๆไวห", "asdfgh", "123xxx", หรือคำที่ไม่สามารถตีความเป็นธุรกิจได้

ให้ทำดังนี้:
1. ห้ามเดาสุ่มหรือ hallucinate ไอเดียธุรกิจ
2. ให้ตีความว่า "ข้อมูลไม่เพียงพอสำหรับการวิเคราะห์"
3. ลด score อย่างมีนัยสำคัญ (ควรอยู่ระดับต่ำ)
4. reasonForScore ต้องระบุชัดเจนว่า input ไม่มีความหมายหรือไม่สามารถตีความได้
5. strategies ให้เป็นแนว "ขอข้อมูลเพิ่ม / แนะนำการกำหนดไอเดียให้ชัด"
6. ยังคงต้องตอบ JSON ให้ครบทุก field (ห้าม fail)
`;
};
